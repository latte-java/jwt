...
public class ECSignerTest extends BaseJWTTest {
  ...
  public void test_private_pem_parsing() {
    // Each algorithm only works with the matching curve
    ...
    // Mismatched curve/algorithm should throw
    expectException(InvalidKeyTypeException.class, () -> ECSigner.newSHA256Signer(readFile("ec_private_key_p_384.pem")));
    expectException(InvalidKeyTypeException.class, () -> ECSigner.newSHA256Signer(readFile("ec_private_key_p_521.pem")));
    expectException(InvalidKeyTypeException.class, () -> ECSigner.newSHA384Signer(readFile("ec_private_key_p_256.pem")));
    expectException(InvalidKeyTypeException.class, () -> ECSigner.newSHA384Signer(readFile("ec_private_key_p_521.pem")));
    expectException(InvalidKeyTypeException.class, () -> ECSigner.newSHA512Signer(readFile("ec_private_key_p_256.pem")));
