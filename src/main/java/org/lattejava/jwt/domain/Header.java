...
package org.lattejava.jwt.domain;
...
public class Header {
  ...
  public Header set(String name, Object value) {
    ...
    if ("alg".equals(name) || "typ".equals(name)) {
      throw new IllegalArgumentException("Cannot set reserved header parameter [" + name + "] via set()");
    }
