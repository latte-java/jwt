...
| Three-segment split check | Yes -- but a two-segment token is accepted if the third segment is present-and-empty (for inspection of unsecured JWTs per RFC 7519 §6), otherwise `MissingSignatureException` |
