...
The `baseline` value in the tables below represents the baseline performance of the JCA
implementation w/out any JWT library code. This value represents that RPS ceiling for the
library. 

<!-- BENCHMARKS:START -->

## Overall leaderboard — decode-verify-validate
